          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700 space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">2.1 Personal Information You Provide</h3>
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-6">2.2 Information We Collect Automatically</h3>
                <ul className="list-disc ml-6 space-y-1">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700 space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">4.1 With Other Users</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-6">4.2 With Service Providers</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-6">4.3 For Legal Reasons</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-gray-900 mt-6">4.4 Business Transfers</h3>
                <p>
