-- Simple test data setup for PitchMoto Discovery
...
-- Step 2: Create test founder user if not exists
INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, recovery_sent_at, last_sign_in_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
VALUES ('11111111-1111-1111-1111-111111111111'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'authenticated', 'authenticated', 'demo.founder@pitchmoto.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider": "email", "providers": ["email"]}', '{"full_name": "Demo Founder"}', NOW(), NOW(), '', '', '', '')
ON CONFLICT (id) DO NOTHING;

INSERT INTO profiles (id, full_name, role, created_at, updated_at)
VALUES ('11111111-1111-1111-1111-111111111111'::uuid, 'Demo Founder', 'founder', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
-- Step 4: Insert test startups
INSERT INTO startups (id, name, tagline, description, sector, location, website_url, country, founded_year, team_size, founder_id) VALUES
('22222222-2222-2222-2222-222222222222'::uuid, 'TechFlow AI', 'Automating business workflows with intelligent AI', 'TechFlow AI revolutionizes how businesses handle repetitive tasks by providing intelligent automation solutions that learn and adapt to your workflow patterns.', 'Technology', 'San Francisco, CA', 'https://techflow.ai', 'United States', 2023, 28, '11111111-1111-1111-1111-111111111111'::uuid),

('33333333-3333-3333-3333-333333333333'::uuid, 'GreenEnergy Solutions', 'Sustainable solar power for everyone', 'We make solar energy accessible and affordable for residential and commercial properties through innovative financing and installation solutions.', 'Energy', 'Austin, TX', 'https://greenenergy.com', 'United States', 2022, 15, '11111111-1111-1111-1111-111111111111'::uuid),

('44444444-4444-4444-4444-444444444444'::uuid, 'HealthTrack Pro', 'Personal health monitoring made simple', 'HealthTrack Pro combines wearable technology with AI-powered insights to help individuals monitor and improve their health outcomes.', 'Healthcare', 'Boston, MA', 'https://healthtrack.pro', 'United States', 2024, 22, '11111111-1111-1111-1111-111111111111'::uuid),

('55555555-5555-5555-5555-555555555555'::uuid, 'EduVerse VR', 'Immersive virtual reality education platform', 'EduVerse creates immersive VR educational experiences that transport students to historical events, inside molecular structures, and across the universe.', 'Education', 'London, UK', 'https://eduverse.com', 'United Kingdom', 2023, 18, '11111111-1111-1111-1111-111111111111'::uuid),

('66666666-6666-6666-6666-666666666666'::uuid, 'FinanceFlow', 'Democratizing investment access globally', 'FinanceFlow provides micro-investment platforms for underserved populations, enabling anyone to invest with as little as $1.', 'Finance', 'Singapore', 'https://financeflow.com', 'Singapore', 2024, 12, '11111111-1111-1111-1111-111111111111'::uuid);
...
-- Step 6: Create some test upvotes and comments (optional)
-- You can add these after creating investor accounts
