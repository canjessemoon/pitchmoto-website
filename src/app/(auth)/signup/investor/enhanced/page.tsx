  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      if (formData.accountType === 'paid') {
        ...
        console.log('Paid account selected, but Stripe integration not yet implemented')
        console.log('Plan type:', formData.planType)
        
        // For now, just log the payment details and continue with account creation
        console.log('Would create subscription with:', {
        ...
        finalPaymentMethodId = 'payment_skipped_for_testing'
      }
      ...
      if (data?.user) {
        ...
        await profileHelpers.updateProfile(data.user.id, {
          ...
          // Note: subscription_type would be stored in the subscriptions table
        })
