    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg p-8">
          <h1 className="text-3xl font-bold text-[#405B53] mb-8">Terms of Service</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">2. Description of Service</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">3. User Accounts</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">4. Acceptable Use</h2>
              <div className="text-gray-700 space-y-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">5. Content and Intellectual Property</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">6. Paid Services</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">7. Analytics and Third-Party Services</h2>
              <div className="text-gray-700 space-y-4">
                <p>
                  <strong>7.1 Google Analytics:</strong> We use Google Analytics 4 ("GA4") to understand how visitors use our website and to help us improve our services. GA4 collects information such as your device type, browser, general location, and interactions with our website. This data is collected using cookies and similar technologies and is processed in a pseudonymous form — we do not use GA4 to collect names, email addresses, or other directly identifying information.
                </p>
                <p>
                  Google processes this information on our behalf under the Google Ads Data Processing Terms. Data may be transferred outside your country, including to the United States, and such transfers are safeguarded through mechanisms such as Standard Contractual Clauses and participation in the EU–U.S. Data Privacy Framework.
                </p>
                <p>
                  You can control the use of GA4 through your browser's cookie settings, by adjusting preferences in our cookie banner, or by installing the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#E64E1B] hover:underline">Google Analytics opt-out browser add-on</a>. Analytics data is retained for no longer than 14 months.
                </p>
                <p>
                  <strong>7.2 Other Third-Party Services:</strong> Our Service also integrates with various other third-party services including Supabase for database and authentication services, Stripe for payment processing, and email service providers for communications. These services may process your data in accordance with their own terms of service and privacy policies.
                </p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">8. Privacy and Data Protection</h2>
              <p className="text-gray-700 mb-4">
                Your privacy is important to us. Please review our <Link href="/privacy" className="text-[#E64E1B] hover:underline">Privacy Policy</Link>, which also governs your use of the Service, to understand our practices regarding data collection, use, and protection.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">9. Disclaimers and Limitation of Liability</h2>
              <div className="text-gray-700 space-y-4">
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">10. Termination</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">11. Changes to Terms</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#405B53] mb-4">12. Contact Information</h2>
              <p className="text-gray-700 mb-4">
