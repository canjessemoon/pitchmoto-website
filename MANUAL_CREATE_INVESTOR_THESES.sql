...
-- Creates the investor_theses table with country-based location preferences
...
DROP TRIGGER IF EXISTS update_investor_theses_updated_at ON investor_theses;
...
DROP POLICY IF EXISTS "Investors can view their own theses" ON investor_theses;
DROP POLICY IF EXISTS "Investors can create their own theses" ON investor_theses;
DROP POLICY IF EXISTS "Investors can update their own theses" ON investor_theses;
DROP POLICY IF EXISTS "Investors can delete their own theses" ON investor_theses;
